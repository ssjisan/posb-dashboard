...
import EventInformation from "./UpdateEventInformation";
import UpdateEventDetails from "./UpdateEventDetails";
import UpdateEventCover from "./UpdateEventCover";
...
export default function UpdateForm() {
    ...
    const fetchData = async () => {
      try {
        ...
        if (data) {
          ...
          setEventDate(data.eventDate ? dayjs(data.eventDate) : null);
          setEventTime(data.eventTime ? dayjs(data.eventTime) : null);
          setRegistrationLink(data.registrationLink);
          setDetails(data.details);
          setRegistrationStartDate(data.registrationStartDate ? dayjs(data.registrationStartDate) : null);
          setRegistrationEndDate(data.registrationEndDate ? dayjs(data.registrationEndDate) : null);
          setEventDate(data.eventDate ? dayjs(data.eventDate) : null);
  ...
  const handleSubmit = async () => {
    ...
    const toastId = toast.loading("Updatingg..."); // Show a loading toast
    ...
    try {
      const { data } = await axios.put(`/event/${id}`, formData, {
        headers: {
